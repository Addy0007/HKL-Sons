...
// ✅ Updated with your seeded categories
const navigation = {
  categories: [
    {
      id: 'women',
...
export default function Navigation() {
  ...
  return (
    <div style={{ backgroundColor: '#FFFEC2' }} className="fixed top-0 left-0 right-0 z-50">
      {/* Mobile menu */}
                        ...
                        >
                          {section.items.map((item) => (
                            <li key={item.name} className="flow-root">
                              <button
                                onClick={() => handleCategoryClick(category.id, section.id, item.id, null)}
                                        ...
                                        >
                                          {section.items.map((item) => (
                                            <li key={item.name} className="flex">
                                              <button
                                                onClick={() => handleCategoryClick(category.id, section.id, item.id, close)}
                                                className="text-gray-600 transition-colors hover:text-[#3D8D7A]"
                                              >
                                                {item.name}
                                              </button>
                                            </li>
                  ...
                  {jwt ? (
                    ...
                    <>
                      <button 
                        ...
                        className="text-sm font-medium text-gray-700 transition-colors hover:text-[#3D8D7A]"
                      >
                        Sign in
                      </button>
